...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-4b7f3e2c9a1d8f6e5b4c3a2f1e0d9c8b7a6f5e4d3c2b1a0f')
...
AUDIT_SETTINGS = {
    ...
    'AUDIT_DATA_RETENTION_DAYS': 2555,  # 7 years for compliance
