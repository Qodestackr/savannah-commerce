...
class Product(AuditableMixin, TimeStampedModel):
    ...
    reserved_quantity = models.PositiveIntegerField(default=0, help_text="Stock reserved for pending orders")
    allocated_quantity = models.PositiveIntegerField(default=0, help_text="Stock allocated for confirmed orders")
    ...
    def available_quantity(self):
        ...
        return max(0, self.stock_quantity - self.reserved_quantity - self.allocated_quantity)
...
class StockMovement(TimeStampedModel):
    ...
    reference_id = models.UUIDField(null=True, blank=True, help_text="Reference to order, reservation, etc.")
