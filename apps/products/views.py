...
class CategoryViewSet(viewsets.ModelViewSet):
    ...
    def products(self, request, slug=None):
        ...
        products = (
            Product.objects.filter(category__in=descendant_categories, is_active=True)
    ...
    def analytics(self, request, slug=None):
        ...
        analytics = {
            ...
            "total_stock": products.aggregate(total=models.Sum("stock_quantity"))[
                "total"
            ]
            or 0,
...
class ProductViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        queryset = queryset.select_related("category").prefetch_related(
            "category__parent", "category__ancestors"
        )
    ...
    def low_stock_products(self, request):
        ...
        low_stock = (
            self.get_queryset()
            .filter(stock_quantity__lte=10, stock_quantity__gt=0, is_active=True)
